...
const DashboardSidebar = (props) => {
  ...
  const COMPACT = sidebarCompact && !onHover ? 1 : undefined; // handle active current page

  const activeRoute = (path) => (router.pathname === path ? 1 : undefined); // handle navigate to another route and close sidebar drawer in mobile device
